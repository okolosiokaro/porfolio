  ...
  return (
    <>
      ...
      <section className="h-auto bg-white">
        <div className="mx-auto h-full w-[90%] py-20 md:w-[70%]">
          <div className="w-full">
            <div className="mb-3">
              <h1 className="mb-3 uppercase text-primary">Get in touch</h1>
              ...
              <p className="mb-2">
                ...
                collaborate and build something amazing together. Drop me a
                message, and I'll get back to you as soon as possible.
              </p>

              <p className="mb-2">
                Whether you're a startup seeking a reliable partner or an
                established company aiming to enhance your digital presence, I'm
                here to help.
              </p>

              <p className="mb-5">
                Let's collaborate to turn your ideas into reality with
                cutting-edge technology and efficient, scalable solutions. Feel
                free to reach out for consultations, project discussions, or any
                technical inquiries.
              </p>
            </div>
            <div className="mt-8 grid grid-cols-2 gap-5">
              ...
              <div className="col-span-1">
                ...
                <a
                  href="https://www.linkedin.com/in/okolosiokaro/"
                  target="_blank"
                  className="font-semibold italic underline"
              ...
              <div className="col-span-1">
                ...
                <a
                  href="https://github.com/okolosiokaro"
                  target="_blank"
                  className="font-semibold italic underline"
                  rel="noopener noreferrer"
                >
              ...
              <div className="col-span-1">
                ...
                <a
                  href="https://wa.me/2347050754245"
                  className="font-semibold italic underline"
                >
                  send a message
                </a>
