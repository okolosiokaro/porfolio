...
const ScrollList = ({ Project }) => {
  ...
  return (
    <div>
      ...
      <button
        className="absolute left-0 top-1/2 bg-blue-400 hover:bg-blue-500 p-2 rounded-full z-10 text-white"
      ...
      <div id="scrollContainer" className="flex overflow-x-auto" style={{ scrollBehavior: 'smooth' }}>
        {Projects.map((Project) => (
                <div key={Project.id}  className="flex-none w-full md:w-1/2 flex flex-col justify-center items-center border border-gray-300 m-2">
